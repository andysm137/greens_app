...
- `lib/screens/booking_skill_matrix_view.dart`: event/dance-scoped Skill Matrix grid limited to attendees, with tap-to-primary assignment sharing Dance Builder's booking data.
