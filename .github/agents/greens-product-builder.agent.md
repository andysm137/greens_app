...
- Treat the system requirements document as the product source of truth and the SQL document as a working database reference. Reconcile conflicts explicitly instead of silently choosing one.
